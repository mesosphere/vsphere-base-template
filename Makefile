...
rocky: manifests/d2iq-base-RockyLinux-8.7$(NAME_POSTFIX).json
...
rocky-test: rocky-8.7-test-clean #rocky-9.5-test-clean
...
rocky-release: rocky-8.7-release #rocky-9.5-release
...
rocky-ovf: rocky-8.7-ovf #rocky-9.5-ovf
