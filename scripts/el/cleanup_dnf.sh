...
# taken from https://github.com/chef/bento/blob/0c64148b2179bdb88268b06425cdde657f9169f0/packer_templates/scripts/rhel/cleanup_dnf.sh
...
truncate -s 0 /var/lib/dbus/machine-id || true  # if not symlinked to "/etc/machine-id"
